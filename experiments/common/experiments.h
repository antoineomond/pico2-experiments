...
uint8_t execute_benchmarks(uint bench_noop_size, uint bench_prime_size, uint bench_multi_size, uint bench_mat_size, uint bench_mat_foat_size, uint bench_mat_double_size, uint nb_iteration_mat_mul);
